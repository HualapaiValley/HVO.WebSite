...
public partial class HvoDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            var connectionString = Environment.GetEnvironmentVariable("ConnectionStrings__HualapaiValleyObservatory");
            if (string.IsNullOrWhiteSpace(connectionString))
            {
                throw new InvalidOperationException(
                    "No SQL Server provider configured for HvoDbContext. Set ConnectionStrings__HualapaiValleyObservatory in environment variables or configure DbContext in DI.");
            }
