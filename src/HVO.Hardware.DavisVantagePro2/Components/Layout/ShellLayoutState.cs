...
{
    private static readonly ShellFooterItem DefaultFooterSlot1 = new("Davis VP2");
    private static readonly ShellFooterItem DefaultFooterSlot2 = new("Weather overview");
    private static readonly ShellFooterItem DefaultFooterSlot3 = new("MudBlazor shell");
    private static readonly ShellFooterItem DefaultFooterSlot4 = new("Fixed width layout");
    private static readonly ShellFooterItem DefaultFooterSlot5 = new("Connection");
    ...
    public string PageTitle { get; private set; } = "Davis weather dashboard";

    public string PageSummary { get; private set; } = "MudBlazor shell template for the Davis weather monitor.";
    ...
    {
        SetFooter(DefaultFooterSlot1, DefaultFooterSlot2, DefaultFooterSlot3, DefaultFooterSlot4, DefaultFooterSlot5);
    }
