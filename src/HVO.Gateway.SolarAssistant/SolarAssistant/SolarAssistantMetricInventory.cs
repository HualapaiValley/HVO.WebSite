...
public static class SolarAssistantMetricInventoryBuilder
{
    private static readonly HashSet<string> DbCandidateTopics = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "inverter_1/pv_power_1",
        "inverter_1/pv_power_2",
        "inverter_1/pv_voltage_1",
        "inverter_1/pv_voltage_2",
        "inverter_1/pv_current_1",
        "inverter_1/pv_current_2",
        "inverter_1/load_power",
        "inverter_1/load_apparent_power",
        "inverter_1/system_and_load_power",
        "inverter_1/battery_voltage",
        "inverter_1/battery_current",
        "inverter_1/battery_power",
    };
