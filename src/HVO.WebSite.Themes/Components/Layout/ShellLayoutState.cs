...
{
    private static readonly ShellFooterItem DefaultFooterSlot1 = new("Status");
    private static readonly ShellFooterItem DefaultFooterSlot2 = new("Gateway");
    private static readonly ShellFooterItem DefaultFooterSlot3 = new("Ready");
    private static readonly ShellFooterItem DefaultFooterSlot4 = new("Telemetry");
    ...
    public string PageSummary { get; private set; } = "Live telemetry and gateway status.";
