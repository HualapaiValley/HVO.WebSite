...
CREATE PROCEDURE [dbo].[DavisVantageProConsoleRecords_OneMinuteAverage_Rollup] 
  @iRecordDateTimeStart datetimeoffset(7),
  @iRecordDateTimeEnd datetimeoffset(7)
AS
BEGIN

INSERT INTO [DavisVantageProConsoleRecords_OneMinuteArchive]
SELECT 
    ...
    CAST(AVG(barometerTrend) as smallint) as barometerTrend,
	...
	CAST(AVG(tenMinuteWindSpeedAverage) as tinyint) as tenMinuteWindSpeedAverage,
	...
	MIN(forcastIcons) as forcastIcons,
  ...
  GROUP BY
    --recordDateTimeYear, recordDateTimeMonth, recordDateTimeDay, recordDateTimeHour, recordDateTimeMinute
