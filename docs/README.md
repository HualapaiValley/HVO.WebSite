...
This directory holds current reference, operational notes, discovery findings, and archived planning material.
...
These are retained as historical design notes, not active plans.

- `archive/EDGE_OUTBOX_AND_GATEWAY_PLAN.md`
- `archive/PLAN.md`
- `archive/WEATHER_CONTROLLER_PLAN.md`
