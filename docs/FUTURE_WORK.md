...
| P1 | Retired SolarAssistant volume disposition | Decide whether to archive or delete the preserved SolarAssistant outbox and data-protection volumes. | Do not remove them through broad Docker volume cleanup; record the explicit disposition and any required backup first. |
...
- What evidence and retention requirement should govern final disposition of the preserved SolarAssistant outbox and data-protection volumes?
